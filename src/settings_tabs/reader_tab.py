"""
Tab impostazioni reader: modalità lettura e sfondo LIBRARY.

IMPORTANTE: Lo sfondo personalizzabile è per LibraryView,
non per il reader delle pagine.
"""
import os
...
class ReaderTab(QWidget):
    """Tab per impostazioni reader (RTL + doppia pagina) e sfondo libreria."""
    ...
    def init_ui(self):
        ...
        # IMPORTANTE: Cambiato da "Sfondo Lettore" a "Sfondo Libreria"
        background_group = QGroupBox("Sfondo Libreria (Library View)")
        background_layout = QVBoxLayout()

        # Info importante
        library_info = QLabel(
            "NOTA: Queste impostazioni modificano lo sfondo della schermata principale (LibraryView),\n"
            "non del lettore manga."
        )
        library_info.setWordWrap(True)
        library_info.setStyleSheet("color: #FF6B6B; font-size: 10px; font-weight: bold; padding: 5px;")
        ...
        # CAMBIATO: da "reader.background_color" a "library.background_color"
        ...
        # CAMBIATO: da "reader.background_image" a "library.background_image"
    ...
    def get_values(self):
        ...
        # Background settings (CAMBIATO: ora per library, non reader)
        ...
        return {
            ...
            "library.background_color": self.current_bg_color,  # CAMBIATO
            "library.background_image": bg_image  # CAMBIATO
        }
